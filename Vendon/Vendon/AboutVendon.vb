...
#Region "Template Code"
    ...
    Private Sub AboutVendon_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim startposition As New Point(Location.X, Location.Y + 30)
    ...
    Private Sub opentimer_Tick(sender As Object, e As EventArgs) Handles opentimer.Tick
        Opacity = Opacity + 0.1
        Dim openingposition As New Point(Location.X, Location.Y - 3)
        Location = openingposition
        If Opacity = 1 Then
            opentimer.Stop()
        End If
    End Sub
